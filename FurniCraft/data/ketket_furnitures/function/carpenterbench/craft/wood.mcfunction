...
execute unless data block ~ ~ ~ Items[{Slot:14b}] run tag @s add crafted
execute unless data block ~ ~ ~ Items[{Slot:15b}] run tag @s add crafted
execute unless data block ~ ~ ~ Items[{Slot:16b}] run tag @s add crafted

execute as @s[tag=woolon] run function ketket_furnitures:carpenterbench/craft/woolon