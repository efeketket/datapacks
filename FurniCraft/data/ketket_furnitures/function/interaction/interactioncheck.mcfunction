...
execute if data entity @s SelectedItem{id:"minecraft:wooden_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
execute if data entity @s SelectedItem{id:"minecraft:iron_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
execute if data entity @s SelectedItem{id:"minecraft:stone_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
execute if data entity @s SelectedItem{id:"minecraft:golden_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
execute if data entity @s SelectedItem{id:"minecraft:diamond_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
execute if data entity @s SelectedItem{id:"minecraft:netherite_axe"} run return run execute as @e[type=interaction,limit=1,sort=nearest,tag=!stripped] positioned ~ ~0.5 ~ run function ketket_furnitures:interaction/strip
